 ...
 *  2) 상위 패키지와 하위 패키지는 . 로 구분한다
 *  3) 패키지 선언은 소스코드의 가장 윗 부분에 온다.
 *  
 */
package com.edu.pro;

// class 클래스이름...Greeting
/*
 * 1) 클래스 이름은 반드시 대문자로 시작한다...매너
 * 2) 클래스 이름으로 파일명이 결정된다.
 * 3) 클래스의 확장자는 java이다.
 */
public class GreetingTest { //이런 클래스를 실행클래스..GreetingTest/GreetingAppTest
	
	// 메소드...main메소드
	// main메소드가 있는 클래스는 실행? 대상이 된다./ 
	public static void main(String[] args) {
		//콘솔창에   "안녕하세요..처음 뵙겠습니다^^" 라는 메세지를 출력
